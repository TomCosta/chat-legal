...
googleLoginService.factory('googleLogin', [
    ...
    function($http, $q, $interval, $log, timeStorage) {
        ...
        service.redirect_url = 'http://localhost:8100/*'; // 'http://localhost/chatApp/www/';
        service.client_id = '823784912345-asdyuighj9go5qof4fmmmnroer729cp1.apps.googleusercontent.com';
        service.secret = 'AGttw0927d8dh9s';
